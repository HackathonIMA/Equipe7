	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-3 col-lg-2 bgMenu hidden-xs">
				...
				<nav>
						<ul>
							<li onclick="menu('atendimento')"><a href="#" title="ATENDIMENTOS" tabindex="1"><i class="glyphicon glyphicon-cog"></i> &nbsp;ATENDIMENTOS</a></li>
							<li onclick="menu('protocolo')"><a href="#" id="protocolo" title="PROTOCOLOS" tabindex="2"><i class="glyphicon glyphicon-folder-open"></i> &nbsp;PROTOCOLOS</a><li>
						</ul>
				</nav>
                <div id="results">
